...
from core.container import get_container, cleanup_container
...
from domain.exceptions import ValidationError, EmbeddingError, VectorIndexError, RepositoryError, LLMError
...
@app.post("/prompt", response_model=PromptResponse, responses={
